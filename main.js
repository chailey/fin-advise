...
var PLAID_CLIENT_ID = '5be216c844fc260011e05b61';
var PLAID_SECRET = '19f5053296c40d882a55c3514a4690';
var PLAID_PUBLIC_KEY = '95c2e70edbcf88880c23dbc4d7e7cd';
...
theApp.on('window-all-closed', function() {
...
theApp.get('/', function(request, response, next) {
...
theApp.post('/get_access_token', function(request, response, next) {
...
theApp.get('/transactions', function(request, response, next) {
...
theApp.get('/identity', function(request, response, next) {
...
theApp.get('/balance', function(request, response, next) {
...
theApp.get('/accounts', function(request, response, next) {
...
theApp.get('/auth', function(request, response, next) {
...
theApp.get('/assets', function(request, response, next) {
...
theApp.get('/item', function(request, response, next) {
...
var server = theApp.listen(APP_PORT, function() {
...
theApp.post('/set_access_token', function(request, response, next) {
